...
private myGmhim:GMH[];
  constructor(private http:HttpClient) { }
    ...
    getAllGmhs():Observable<GMH[]> {
      return this.http.get<GMH[]>(environment.url+'gmh/getAllGmhs');
      }
  ...
  getGmhByGmhCode(gmhCode:GMH):Observable<GMH>{
    console.log("service")
    return this.http.post<GMH>(environment.url+'gmh/getGmhByGmhCode',gmhCode);
  }
